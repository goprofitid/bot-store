...
const product = {
   product: ["VCC", "CLOUD", "DOMAIN", "APP PREMIUM", "TUNNELING", "NPWP", "LEGALITAS PT","RDP","PULSA","CONVERT"],
}
...
export default {
   ...
   options: {
      ...
      owner: ["62895415430305","6282125388500"], // set owner number on here
   ...
   Exif: {
      packId: "https://goprofit.id",
      packName: `Owner:`,
      packPublish: "Dendi Ramadhan",
      packEmail: "dendi@nasa.gov",
      packWebsite: "https://goprofit.id",
